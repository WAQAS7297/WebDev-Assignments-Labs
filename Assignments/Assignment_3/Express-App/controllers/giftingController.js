...
exports.getAllGifting = async (req, res, next) => {
    try {
...
exports.getGiftingByCategory = async (req, res, next) => {
    try {
...
exports.addGiftingProduct = async (req, res, next) => {
    try {
        const newProduct = new GiftingProduct(req.body);
...
exports.updateGiftingProduct = async (req, res, next) => {
    try {
        const updatedProduct = await GiftingProduct.findByIdAndUpdate(
            req.params.id,
            req.body,
...
exports.deleteGiftingProduct = async (req, res, next) => {
    try {
        const product = await GiftingProduct.findByIdAndDelete(req.params.id);
        if (!product) {
            return res.status(404).json({ 
                success: false, 
                message: 'Product not found' 
