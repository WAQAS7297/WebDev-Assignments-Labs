...
exports.getAllSnack = async (req, res, next) => {
    try {
...
exports.getSnackByCategory = async (req, res, next) => {
    try {
...
exports.addSnackProduct = async (req, res, next) => {
    try {
...
exports.updateSnackProduct = async (req, res, next) => {
    try {
...
exports.deleteSnackProduct = async (req, res, next) => {
    try {
