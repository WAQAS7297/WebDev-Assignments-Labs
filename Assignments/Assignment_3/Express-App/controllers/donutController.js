...
exports.getAlldonut = async (req, res, next) => {
    try {
...
exports.getDonutByCategory = async (req, res, next) => {
    try {
...
exports.addDonutProduct = async (req, res, next) => {
    try {
        const newProduct = new DonutProduct(req.body);
...
exports.updateDonutProduct = async (req, res, next) => {
    try {
        const updatedProduct = await DonutProduct.findByIdAndUpdate(
            req.params.id,
            req.body,
...
exports.deleteDonutProduct = async (req, res, next) => {
    try {
        const product = await DonutProduct.findByIdAndDelete(req.params.id);
        if (!product) {
            return res.status(404).json({ 
                success: false, 
                message: 'Product not found' 
